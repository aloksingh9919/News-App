...
function fetchnews(general) {
    ...
    startSlideshow(data.articles);
            ...
            data.articles.forEach(element => {
                ...
                const description = element.description || element.content || `The “X” logo is a part of the larger effort to make the micro-blogging platform into an “everything app” modelled on the lines of Chinas WeChat`
                
                const newscontainer = document.createElement('div')
                newscontainer.innerHTML = `
                <div class="card m-2 main-card" style="width: 18rem;" >
                <img src=${element.urlToImage || "https://static.vecteezy.com/system/resources/thumbnails/006/299/370/original/world-breaking-news-digital-earth-hud-rotating-globe-rotating-free-video.jpg"} 
           ...
           <div class="smallbox">
           <a href=${element.url} class="btn btn-danger shadow" style="background-color:red;" >Read More</a>
           <p>${date}</p>
           </div>
           </div>
           </div>`
...
// ======================carousel======================
    ...
    function startSlideshow(articles) {
        ...
        function updateImage() {
            slideshowImg.src = articles[currentIndex].urlToImage || "https://static.vecteezy.com/system/resources/thumbnails/006/299/370/original/world-breaking-news-digital-earth-hud-rotating-globe-rotating-free-video.jpg";
...
//     const slideshowImg = document.getElementById("slideshow-img");
//     const apiUrl = `https://newsapi.org/v2/top-headlines?country=in&category=${general}&apiKey=e284532b259847f0be14d7edfead684e`; // Replace this with the actual API URL.
...
//     // Fetch images and start the slideshow
//     fetchImages();
//   });
